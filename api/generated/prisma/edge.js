...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/koshi/private-dev/mcp-todos/api/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/koshi/private-dev/mcp-todos/api/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// folder \"prisma\" & .env & .gitignoreは'npm install prisma --save-dev'と'npx prisma init --datasource-provider sqlite --output ../generated/prisma'と記入\n\n// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"sqlite\"\n  url      = env(\"DATABASE_URL\")\n}\n\n//追加\nmodel Todo {\n  id        Int      @id @default(autoincrement())\n  title     String\n  completed Boolean  @default(false)\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "ebbd15f745ebc167224d69e989830e7835abcc00dd970cbecfe6dc5b7fe741c3",
  "copyEngine": true
}
config.dirname = '/'
